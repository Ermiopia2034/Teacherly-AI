        ...
        <div className={styles.sidebarContent}>
          <div className={styles.sidebarSection}>
            ...
            <nav className={styles.sidebarNav}>
              <Link href="/dashboard" className={`${styles.navItem} ${isActive('/dashboard') && !isActive('/dashboard/generation-hub') && !isActive('/dashboard/students') && !isActive('/dashboard/grades') && !isActive('/dashboard/my-contents') ? styles.active : ''}`}>
